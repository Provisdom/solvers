...
(defn quadratic-programming
  ...
  `::quadratic-guess` must meet constraints and must strictly meet the
  `less-than` constraints. Returns a map with `::vector-point` and `::value`."
